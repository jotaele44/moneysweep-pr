...
OUTPUT_COLUMNS = [
    ...
    "federal_awards_obligated",
    "federal_transfers_per_capita",
    "data_source",
]
...
KNOWN_MUNICIPAL_DATA = [
    ...
    },
    {
        ...
        "fiscal_year": "2023",
        "federal_awards_count": "1100",
        "federal_awards_obligated": "420000000",
        "federal_transfers_per_capita": "2800",
        "data_source": "usaspending_known_seed",
    },
    {
        "municipality": "Carolina",
        "fiscal_year": "2023",
        "federal_awards_count": "850",
        "federal_awards_obligated": "310000000",
        "federal_transfers_per_capita": "2100",
        "data_source": "usaspending_known_seed",
    },
    {
        "municipality": "Ponce",
        "fiscal_year": "2023",
        "federal_awards_count": "780",
        "federal_awards_obligated": "290000000",
        "federal_transfers_per_capita": "2000",
        "data_source": "usaspending_known_seed",
    },
    {
        "municipality": "Caguas",
        "fiscal_year": "2023",
        "federal_awards_count": "650",
        "federal_awards_obligated": "240000000",
        "federal_transfers_per_capita": "1900",
        "data_source": "usaspending_known_seed",
    },
]
...
def run(
    ...
    if out_path.exists() and not force:
        ...
        logger.info(
            f"  Municipal: {out_path.name} exists ({row_count:,} rows) — skipping. Use --force."
        )
