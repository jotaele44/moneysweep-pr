...
def build_edges(root: Path | None = None, node_ids: set[str] | None = None) -> list[dict[str, Any]]:
...
def check(
    nodes: list[dict[str, Any]], edges: list[dict[str, Any]], root: Path | None = None
) -> list[str]:
