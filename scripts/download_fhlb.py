...
KNOWN_FHLB_DATA = [
    {
        "institution_name": "BANCO POPULAR DE PUERTO RICO",
        "institution_normalized": "BANCO POPULAR DE PUERTO RICO",
        "fdic_cert": "32473",
        "reporting_date": "2023-12-31",
        "fiscal_year": "2023",
        "advances_outstanding": "2500000000",
        "advance_type": "Fixed Rate Credit",
        "collateral_type": "Mortgage loans",
        "source": "FHLB_NY_Annual_Report_2023",
    },
    {
        "institution_name": "FIRSTBANKPR",
        "institution_normalized": "FIRSTBANKPR",
        "fdic_cert": "33063",
        "reporting_date": "2023-12-31",
        "fiscal_year": "2023",
        "advances_outstanding": "850000000",
        "advance_type": "Adjustable Rate Credit",
        "collateral_type": "Mortgage loans",
        "source": "FHLB_NY_Annual_Report_2023",
    },
    {
        "institution_name": "ORIENTAL BANK",
        "institution_normalized": "ORIENTAL BANK",
        "fdic_cert": "57506",
        "reporting_date": "2023-12-31",
        "fiscal_year": "2023",
        "advances_outstanding": "420000000",
        "advance_type": "Fixed Rate Credit",
        "collateral_type": "Mortgage loans",
        "source": "FHLB_NY_Annual_Report_2023",
    },
...
def _run(root=None, force=False):
    ...
    known_inst_names = (
        set(df["institution_name"].dropna().tolist()) if "institution_name" in df.columns else set()
    )
