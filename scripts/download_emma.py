...
KNOWN_EMMA_BONDS = [
    ...
    {
        "cusip": "74526QBB2",
        "issuer_name": "Puerto Rico Sales Tax Financing Corp",
        "issuer_normalized": "PUERTO RICO SALES TAX FINANCING CORP",
        "issuer_state": "PR",
        "description": "COFINA Senior Bonds Series 2019A",
        "issue_date": "2019-02-12",
        "fiscal_year": "2019",
        "maturity_date": "2058-07-01",
        "par_amount": "12114600000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "PROMESA restructuring",
        "underwriter_name": "Citigroup Global Markets",
        "underwriter_normalized": "CITIGROUP GLOBAL MARKETS",
    },
    {
        "cusip": "74526QBC0",
        "issuer_name": "Puerto Rico Sales Tax Financing Corp",
        "issuer_normalized": "PUERTO RICO SALES TAX FINANCING CORP",
        "issuer_state": "PR",
        "description": "COFINA Subordinate Bonds Series 2019B",
        "issue_date": "2019-02-12",
        "fiscal_year": "2019",
        "maturity_date": "2040-07-01",
        "par_amount": "4199400000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "PROMESA restructuring",
    ...
    # --- GO Bonds ---
    {
        ...
        "issuer_normalized": "COMMONWEALTH OF PUERTO RICO",
        "issuer_state": "PR",
        "description": "GO Bonds Series 2022A",
        "issue_date": "2022-03-15",
        "fiscal_year": "2022",
        "maturity_date": "2051-07-01",
        "par_amount": "7000000000",
        "coupon_rate": "0.0400",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "PROMESA plan of adjustment",
        "underwriter_name": "Goldman Sachs",
        "underwriter_normalized": "GOLDMAN SACHS",
    },
    {
        "cusip": "745145SW1",
        "issuer_name": "Commonwealth of Puerto Rico",
        "issuer_normalized": "COMMONWEALTH OF PUERTO RICO",
        "issuer_state": "PR",
        "description": "GO Bonds Series 2014A",
        "issue_date": "2014-03-17",
        "fiscal_year": "2014",
        "maturity_date": "2035-07-01",
        "par_amount": "3500000000",
        "coupon_rate": "0.0800",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "General obligation",
        "underwriter_name": "Barclays Capital",
        "underwriter_normalized": "BARCLAYS CAPITAL",
    },
    {
        "cusip": "745145SK7",
        "issuer_name": "Commonwealth of Puerto Rico",
        "issuer_normalized": "COMMONWEALTH OF PUERTO RICO",
        "issuer_state": "PR",
        "description": "GO Bonds Series 2012A",
        "issue_date": "2012-01-25",
        "fiscal_year": "2012",
        "maturity_date": "2042-07-01",
        "par_amount": "1300000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "General obligation",
    ...
    {
        "cusip": "745190AB2",
        "issuer_name": "Puerto Rico Highways and Transportation Authority",
        "issuer_normalized": "PUERTO RICO HIGHWAYS AND TRANSPORTATION AUTHORITY",
        "issuer_state": "PR",
        "description": "HTA Revenue Bonds Series 2022A",
        "issue_date": "2022-04-01",
        "fiscal_year": "2022",
        "maturity_date": "2046-07-01",
        "par_amount": "3420400000",
        "coupon_rate": "0.0525",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "PROMESA restructuring",
        "underwriter_name": "Morgan Stanley",
        "underwriter_normalized": "MORGAN STANLEY",
    },
    {
        "cusip": "74514LKT4",
        "issuer_name": "Puerto Rico Highways and Transportation Authority",
        "issuer_normalized": "PUERTO RICO HIGHWAYS AND TRANSPORTATION AUTHORITY",
        "issuer_state": "PR",
        "description": "HTA Revenue Bonds Series 2003A",
        "issue_date": "2003-09-16",
        "fiscal_year": "2004",
        "maturity_date": "2042-07-01",
        "par_amount": "688000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
    ...
    {
        "cusip": "74529JBQ4",
        "issuer_name": "Puerto Rico Electric Power Authority",
        "issuer_normalized": "PUERTO RICO ELECTRIC POWER AUTHORITY",
        "issuer_state": "PR",
        "description": "PREPA Power Revenue Bonds Series 2013A",
        "issue_date": "2013-06-01",
        "fiscal_year": "2013",
        "maturity_date": "2043-07-01",
        "par_amount": "673000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Utility capital improvements",
        "underwriter_name": "JP Morgan",
        "underwriter_normalized": "JP MORGAN",
    },
    {
        "cusip": "74529JBR2",
        "issuer_name": "Puerto Rico Electric Power Authority",
        "issuer_normalized": "PUERTO RICO ELECTRIC POWER AUTHORITY",
        "issuer_state": "PR",
        "description": "PREPA Power Revenue Bonds Series 2007A",
        "issue_date": "2007-07-01",
        "fiscal_year": "2008",
        "maturity_date": "2040-07-01",
        "par_amount": "520000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Utility operations and capital",
        "underwriter_name": "UBS Financial Services",
        "underwriter_normalized": "UBS FINANCIAL SERVICES",
    },
    # --- PRASA ---
    {
        "cusip": "74528JAD2",
        "issuer_name": "Puerto Rico Aqueduct and Sewer Authority",
        "issuer_normalized": "PUERTO RICO AQUEDUCT AND SEWER AUTHORITY",
        "issuer_state": "PR",
        "description": "PRASA Revenue Bonds Series 2012A",
        "issue_date": "2012-05-01",
        "fiscal_year": "2013",
        "maturity_date": "2047-07-01",
        "par_amount": "750000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Water and sewer infrastructure",
        "underwriter_name": "Bank of America Merrill Lynch",
        "underwriter_normalized": "BANK OF AMERICA MERRILL LYNCH",
    },
    {
        "cusip": "74528JAE0",
        "issuer_name": "Puerto Rico Aqueduct and Sewer Authority",
        "issuer_normalized": "PUERTO RICO AQUEDUCT AND SEWER AUTHORITY",
        "issuer_state": "PR",
        "description": "PRASA Revenue Bonds Series 2008A",
        "issue_date": "2008-01-15",
        "fiscal_year": "2008",
        "maturity_date": "2038-07-01",
        "par_amount": "400000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Capital improvements water system",
        "underwriter_name": "Merrill Lynch Pierce Fenner",
        "underwriter_normalized": "MERRILL LYNCH PIERCE FENNER",
    },
    # --- GDB / PRIFA ---
    {
        "cusip": "74526PBA6",
        "issuer_name": "Puerto Rico Government Development Bank",
        "issuer_normalized": "PUERTO RICO GOVERNMENT DEVELOPMENT BANK",
        "issuer_state": "PR",
        "description": "GDB Senior Notes Series 2015A",
        "issue_date": "2015-01-29",
        "fiscal_year": "2015",
        "maturity_date": "2021-01-01",
        "par_amount": "900000000",
        "coupon_rate": "0.0475",
        "sale_type": "Negotiated",
        "tax_status": "Taxable",
        "use_of_proceeds": "Government liquidity support",
        "underwriter_name": "Santander Securities",
        "underwriter_normalized": "SANTANDER SECURITIES",
    },
    {
        "cusip": "74527CAA5",
        "issuer_name": "Puerto Rico Infrastructure Financing Authority",
        "issuer_normalized": "PUERTO RICO INFRASTRUCTURE FINANCING AUTHORITY",
        "issuer_state": "PR",
        "description": "PRIFA Special Tax Revenue Bonds Series 2005A",
        "issue_date": "2005-09-01",
        "fiscal_year": "2006",
        "maturity_date": "2025-07-01",
        "par_amount": "500000000",
        "coupon_rate": "0.0525",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Infrastructure investment fund",
        "underwriter_name": "Lehman Brothers",
        "underwriter_normalized": "LEHMAN BROTHERS",
    },
    # --- PRHFA / Housing ---
    {
        "cusip": "74527DAA3",
        "issuer_name": "Puerto Rico Housing Finance Authority",
        "issuer_normalized": "PUERTO RICO HOUSING FINANCE AUTHORITY",
        "issuer_state": "PR",
        "description": "PRHFA Mortgage Revenue Bonds Series 2017A",
        "issue_date": "2017-06-01",
        "fiscal_year": "2018",
        "maturity_date": "2047-12-01",
        "par_amount": "180000000",
        "coupon_rate": "0.0400",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Affordable housing mortgage programs",
        "underwriter_name": "RBC Capital Markets",
        "underwriter_normalized": "RBC CAPITAL MARKETS",
    },
    # --- PRIDCO ---
    {
        "cusip": "74526EAA1",
        "issuer_name": "Puerto Rico Industrial Development Company",
        "issuer_normalized": "PUERTO RICO INDUSTRIAL DEVELOPMENT COMPANY",
        "issuer_state": "PR",
        "description": "PRIDCO Revenue Bonds Series 2006A",
        "issue_date": "2006-05-01",
        "fiscal_year": "2007",
        "maturity_date": "2016-07-01",
        "par_amount": "240000000",
        "coupon_rate": "0.0475",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Industrial development fund",
        "underwriter_name": "Popular Securities",
        "underwriter_normalized": "POPULAR SECURITIES",
    },
    # --- UPR ---
    {
        "cusip": "916312AA6",
        "issuer_name": "University of Puerto Rico",
        "issuer_normalized": "UNIVERSITY OF PUERTO RICO",
        "issuer_state": "PR",
        "description": "UPR System Revenue Bonds Series P 2006",
        "issue_date": "2006-06-01",
        "fiscal_year": "2007",
        "maturity_date": "2036-06-01",
        "par_amount": "359000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "University capital improvements",
        "underwriter_name": "Wachovia Bank National Association",
        "underwriter_normalized": "WACHOVIA BANK NATIONAL ASSOCIATION",
    },
    # --- CCDA / Convention Center ---
    {
        "cusip": "74525QAA3",
        "issuer_name": "Puerto Rico Convention Center District Authority",
        "issuer_normalized": "PUERTO RICO CONVENTION CENTER DISTRICT AUTHORITY",
        "issuer_state": "PR",
        "description": "CCDA Hotel Occupancy Tax Revenue Bonds Series 2006A",
        "issue_date": "2006-07-01",
        "fiscal_year": "2007",
        "maturity_date": "2036-12-15",
        "par_amount": "469900000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
    ...
    {
        "cusip": "74528FAA7",
        "issuer_name": "Puerto Rico Ports Authority",
        "issuer_normalized": "PUERTO RICO PORTS AUTHORITY",
        "issuer_state": "PR",
        "description": "Ports Authority Revenue Bonds Series 2003A",
        "issue_date": "2003-03-01",
        "fiscal_year": "2003",
        "maturity_date": "2028-07-01",
        "par_amount": "220000000",
        "coupon_rate": "0.0500",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Port infrastructure improvements",
        "underwriter_name": "Bear Stearns",
        "underwriter_normalized": "BEAR STEARNS",
    },
    # --- PRPFC ---
    {
        "cusip": "74527EAA1",
        "issuer_name": "Puerto Rico Public Finance Corporation",
        "issuer_normalized": "PUERTO RICO PUBLIC FINANCE CORPORATION",
        "issuer_state": "PR",
        "description": "PRPFC Commonwealth Appropriation Bonds Series 2012A",
        "issue_date": "2012-01-01",
        "fiscal_year": "2012",
        "maturity_date": "2031-02-01",
        "par_amount": "1255000000",
        "coupon_rate": "0.0575",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
    ...
    {
        "cusip": "74514MAA8",
        "issuer_name": "Puerto Rico Municipal Finance Agency",
        "issuer_normalized": "PUERTO RICO MUNICIPAL FINANCE AGENCY",
        "issuer_state": "PR",
        "description": "MFA General Resolution Bonds Series 2015A",
        "issue_date": "2015-03-01",
        "fiscal_year": "2015",
        "maturity_date": "2025-08-01",
        "par_amount": "155000000",
        "coupon_rate": "0.0400",
        "sale_type": "Negotiated",
        "tax_status": "Tax-Exempt",
        "use_of_proceeds": "Municipal loan program",
        "underwriter_name": "Banco Popular de Puerto Rico",
        "underwriter_normalized": "BANCO POPULAR DE PUERTO RICO",
    },
]
...
def _fetch_pr_securities(session: requests.Session, logger) -> list[dict]:
    ...
    for endpoint in EMMA_SECURITY_ENDPOINTS:
        ...
        while True:
            ...
            if page == 1:
                total_hint = (
                    data.get("totalCount") or data.get("total") if isinstance(data, dict) else "?"
                )
...
def _records_to_bonds_df(records: list[dict]) -> pd.DataFrame:
    ...
    if df.columns.duplicated().any():
        ...
        for col in df.columns:
            if col not in deduped:
                deduped[col] = (
                    df[col] if not isinstance(df[col], pd.DataFrame) else df[col].iloc[:, 0]
                )
            else:
    ...
    if "issuer_name" not in df.columns:
        df["issuer_name"] = ""
    df["issuer_normalized"] = (
        df["issuer_name"].fillna("").astype(str).apply(lambda x: _normalize_name(x))
    )

    if "underwriter_name" not in df.columns:
        df["underwriter_name"] = ""
    df["underwriter_normalized"] = (
        df["underwriter_name"].fillna("").astype(str).apply(lambda x: _normalize_name(x))
    )
...
def _build_underwriter_df_from_bonds(df_bonds: pd.DataFrame) -> pd.DataFrame:
    ...
    agg = (
        valid.groupby(["underwriter_name", "underwriter_normalized"], dropna=False)
        .agg(
        ...
        rows.append(
            {
                ...
                "total_par_amount": float(
                    pd.to_numeric(
                        r.get("totalParAmount") or r.get("total_par_amount") or 0, errors="coerce"
                    )
                    or 0
                ),
                "deal_count": int(
                    pd.to_numeric(r.get("dealCount") or r.get("deal_count") or 0, errors="coerce")
                    or 0
                ),
                "issuer_count": int(
                    pd.to_numeric(
                        r.get("issuerCount") or r.get("issuer_count") or 0, errors="coerce"
                    )
                    or 0
                ),
...
def run(root: Path | None = None, force: bool = False) -> dict:
    ...
    total_par = float(
        pd.to_numeric(df_bonds.get("par_amount", pd.Series(dtype=str)), errors="coerce").sum()
    )
