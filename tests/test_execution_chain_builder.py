...
def chain_repo(tmp_path):
    ...
    contracts = [
        {
            ...
            "vendor_name": "Fluor Enterprises",
            "agency_name": "DOD",
            "obligated_amount": "9000000",
            "pop_county": "Bayamon",
        },
    ]
    ...
    subs = [
        ...
        # matches pr_contracts_master by generated_internal_id → prime_award_id_join
        {
            ...
            "prime_recipient_name": "Fluor Enterprises",
            "prime_uei": "PUEI003",
            "sub_recipient_name": "Sub Two Inc",
            "sub_uei": "SUEI002",
        ...
        # → subaward_declared_prime (still a linked chain)
        {
            ...
            "prime_recipient_name": "Ghost Prime",
            "prime_uei": "",
            "sub_recipient_name": "Orphan Sub",
            "sub_uei": "",
        ...
        # no prime identifier and no prime name → subaward_record_only
        {
            ...
            "prime_uei": "",
            "sub_recipient_name": "Nameless Sub",
            "sub_uei": "",
...
def test_link_confidence_full_match():
    ...
    score = _link_confidence("AW001", "Prime Corp", "Sub LLC", "PUEI001", "SUEI001", True, True)
    assert score == 1.0
