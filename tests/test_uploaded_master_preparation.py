...
def test_prepare_uploaded_masters_emits_canonical_processed_files(tmp_path):
    ...
    _write_csv(
        contracts,
        [
            "record_id", "dataset", "source_file", "evidence_tier", "vendor_name", "normalized_vendor",
            "agency_name", "normalized_agency", "recipient_uei", "award_date", "fiscal_year", "amount_usd",
            "total_obligated",
        ],
        [{
            "record_id": "c1", "dataset": "pdf_contracts", "source_file": "contract.pdf", "evidence_tier": "T1_FEDERAL",
            "vendor_name": "Alpha LLC", "normalized_vendor": "ALPHA LLC", "agency_name": "FEMA",
            "normalized_agency": "FEDERAL EMERGENCY MANAGEMENT AGENCY", "recipient_uei": "ALPHAUEI",
            "award_date": "", "fiscal_year": "2025", "amount_usd": "1000", "total_obligated": "",
        }],
    )
    _write_csv(
        awards,
        [
            ...
            "description", "source_file", "source_dataset", "award_category",
        ],
        [{
            "award_id": "a1", "recipient_name": "Beta Inc", "recipient_name_normalized": "BETA INC",
            "recipient_uei": "BETAUEI", "awarding_agency": "USACE", "awarding_sub_agency": "USACE",
            "obligated_amount": "2500", "award_date": "2024-05-01", "fiscal_year": "2024", "pop_state": "PR",
            "pop_county": "Ponce", "description": "work", "source_file": "awards.csv", "source_dataset": "contracts",
    ...
    _write_csv(
        lda,
        [
            "canonical_client", "total_lobbying_amount", "report_rows", "nonzero_rows", "first_year", "last_year",
            "registrant_count", "source_client_variants", "pr_relevant", "active_years", "canonical_sector",
        ],
        [{
            "canonical_client": "GAMMA CLIENT", "total_lobbying_amount": "50000", "report_rows": "2",
            "nonzero_rows": "1", "first_year": "2020", "last_year": "2025", "registrant_count": "1",
            "source_client_variants": "1", "pr_relevant": "True", "active_years": "6", "canonical_sector": "infra",
        }],
    )
    ...
    for name in ("entities_resolved.csv", "contracts_master.csv", "financial_flows_master.csv", "entity_edges.csv"):
...
def test_artifact_manifest_records_hashes_and_counts(tmp_path):
    ...
    package.mkdir()
    (package / "manifest.json").write_text('{"producer":"contract-sweeper","export_contract_version":"1.1.0"}\n', encoding="utf-8")
    (package / "entities.jsonl").write_text('{"entity_id":"e1"}\n{"entity_id":"e2"}\n', encoding="utf-8")
