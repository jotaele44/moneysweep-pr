    ...
    registry = {
        "sources": [
            {  # all outputs present, well above min_rows -> fully_materialized, bulk
                "source_id": "big_full", "family": "federal", "required": True,
                "authentication": "none",
            ...
            {  # one of two outputs missing -> partially_materialized
                "source_id": "half_done", "family": "federal", "required": True,
                "authentication": "none",
                "expected_outputs": [
            ...
            {  # present but below min_rows -> partially_materialized (below threshold)
                "source_id": "under_thresh", "family": "territorial", "required": False,
                "authentication": "none",
            ...
            {  # declared output absent -> not_materialized
                "source_id": "absent_src", "family": "bonds", "required": False,
                "authentication": "none",
