...
def test_multiple_rows_all_present():
    raw = pd.DataFrame([
        {"AIR_ID": "PR-001", "FAC_NAME": "Plant A", "VIOL_CNT": "1", "INSP_CNT": "2", "FAC_STATE": "PR"},
        {"AIR_ID": "PR-002", "FAC_NAME": "Plant B", "VIOL_CNT": "0", "INSP_CNT": "1", "FAC_STATE": "PR"},
        {"AIR_ID": "PR-003", "FAC_NAME": "Plant C", "VIOL_CNT": "5", "INSP_CNT": "3", "FAC_STATE": "PR"},
    ])
