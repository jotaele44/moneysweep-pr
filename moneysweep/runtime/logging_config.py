...
``MONEYSWEEP_LOG_FORMAT=json`` for line-delimited JSON. Level comes from
``MONEYSWEEP_LOG_LEVEL`` (default ``INFO``). Stdlib only; never logs secrets.
"""
...
LEVEL_ENV = "MONEYSWEEP_LOG_LEVEL"
FORMAT_ENV = "MONEYSWEEP_LOG_FORMAT"
DEFAULT_LEVEL = "INFO"
...
_HANDLER_FLAG = "_moneysweep_runtime_handler"
...
def configure_logging(
    ...
    *,
    ...
    ``MONEYSWEEP_LOG_*`` env vars when given explicitly.
    """
