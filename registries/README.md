...
The matching pre-commit hook (`regenerate-registry-json` in
[`.pre-commit-config.yaml`](../.pre-commit-config.yaml)) runs the regenerator
...
caught two registries already drifted (`schema_registry.json` was missing the
