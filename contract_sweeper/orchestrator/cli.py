...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--skip-sf133", action="store_true", help="Skip step 6b (SF-133 budget execution data)"
    )
    parser.add_argument(
        "--skip-ed", action="store_true", help="Skip step 6c (Dept of Education grants)"
    )
    parser.add_argument(
        "--skip-hhs", action="store_true", help="Skip step 6d (HHS/HRSA/ACF grants)"
    )
    parser.add_argument("--skip-doj-grants", action="store_true", help="Skip step 6e (DOJ grants)")
    parser.add_argument(
        "--skip-oia", action="store_true", help="Skip step 6f (Office of Insular Affairs grants)"
    )
    parser.add_argument(
        "--skip-haf", action="store_true", help="Skip step 6g (Homeowner Assistance Fund)"
    )
    parser.add_argument(
        "--skip-exim", action="store_true", help="Skip step 6h (Ex-Im Bank loans/guarantees)"
    )
    parser.add_argument(
        "--skip-earmarks", action="store_true", help="Skip step 6i (Congressional earmarks)"
    )
    parser.add_argument(
        "--skip-report-builder",
        action="store_true",
    ...
    parser.add_argument(
        "--skip-fsrs", action="store_true", help="Skip step 15a (FSRS prime-to-sub reporting)"
    )
    parser.add_argument(
        "--skip-cor3", action="store_true", help="Skip step 15b (COR3 PR recovery project tracker)"
    )
    parser.add_argument(
        "--skip-compras",
        action="store_true",
    ...
    parser.add_argument(
        "--skip-usace", action="store_true", help="Skip step 26d (USACE Section 404/10 permit data)"
    )
    parser.add_argument(
        "--skip-eqb",
        action="store_true",
    ...
    parser.add_argument(
        "--skip-act60", action="store_true", help="Skip step 26i (PR Act 60 tax incentive decrees)"
    )
    parser.add_argument(
        "--skip-rum-coverover",
        action="store_true",
    ...
    parser.add_argument(
        "--skip-fhlb", action="store_true", help="Skip step 26k (FHLB advances to PR banks)"
    )
    parser.add_argument(
        "--skip-prepa", action="store_true", help="Skip step 26l (PREPA/Luma/Genera contract data)"
    )
    parser.add_argument(
        "--skip-promesa",
        action="store_true",
    ...
    parser.add_argument(
        "--skip-report", action="store_true", help="Skip step 30 (generate PR investigation report)"
    )
    ...
    parser.add_argument(
        "--skip-va", action="store_true", help="Skip step 21e (VA benefits + VAMC contracts for PR)"
    )
    parser.add_argument(
        "--skip-snap-nap",
        action="store_true",
    ...
    parser.add_argument(
        "--skip-epa", action="store_true", help="Skip step 6k (EPA grants for PR via USASpending)"
    )
    parser.add_argument(
        "--skip-usace-civil",
        action="store_true",
    ...
    parser.add_argument(
        "--skip-preflight", action="store_true", help="Skip the registry readiness preflight"
    )
    return parser
