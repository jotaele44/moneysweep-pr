# FOIA Request — FOIA_f7d5acaf207ff8a5

**Agency:** PR Central Office for Recovery Reconstruction and Resiliency (COR3)  
...
To: PR Central Office for Recovery Reconstruction and Resiliency (COR3) — Oficial de Acceso a la Información Pública
...
información pública, solicito copia de los siguientes records:
  ...
  - Tipo de récord: Disaster-recovery project tracker dataset
...
Puerto Rico. Esta solicitud forma parte del expediente FOIA_f7d5acaf207ff8a5.
